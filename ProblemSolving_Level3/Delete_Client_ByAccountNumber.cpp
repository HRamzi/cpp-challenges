...
bool findClientByAccountNumber(stClient& client, string AccountNumber, vector<stClient> vectClient = loadClientDataFromFile(ClientFilleName)) {
...
bool markClientForDeleteByAccountNumber(vector<stClient>& vectClient, string AccountNumber) {
...
bool deleteClientByAccountNumber(vector<stClient> & vectClient, string AccountNumber) {
	...
	if (findClientByAccountNumber(vectClient, client, AccountNumber)) {
		...
		if (Answer == 'y' || Answer == 'Y') {
			...
			markClientForDeleteByAccountNumber(vectClient, AccountNumber);
			saveClientDataToFile(ClientFilleName, vectClient);

			vectClient = loadClientDataFromFile(ClientFilleName);
...
int main() {
	...
	deleteClientByAccountNumber(vectClient, AccountNumber);
